...
public class LongGameTest extends GameTest {
	 ...
	 * purposes.
	 * 
	 * data = new HashMap<String, Object>(); data.put("player_reset", new
	 * Boolean(true)); ex = new ExecData(GAME, RESET_ACTION, PLAYER_ID,
	 * data); execList.add(ex);
	 */
    }
	...
	assertionBadge(GAME, Arrays.asList("1st_of_the_week"), PLAYER_ID,
		"leaderboard top 3");
	...
	Assert.assertEquals(null,
		s.getCustomData().get("zero_impact_trips_past"));
