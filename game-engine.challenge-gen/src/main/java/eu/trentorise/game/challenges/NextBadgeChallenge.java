...
public class NextBadgeChallenge extends Challenge {
	...
	@Override
	public void compileChallenge(String playerId) throws UndefinedChallengeException {
	...
	@Override
	public void setTemplateParams(Map<String, Object> tp) throws UndefinedChallengeException {
    ...
    protected void setCustomData(Map<String, Object> tp)
    	...
    	if (!tp.containsKey("target"))
    	    throw new UndefinedChallengeException("undefined target for challenge!");
